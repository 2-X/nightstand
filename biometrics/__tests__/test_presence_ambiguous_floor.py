"""Behavioral tests for the is_ambiguous_both exit-freeze fix.

Root cause: once both sides read above NOISE_THRESHOLD but
...
class TestAmbiguousFloorExit(unittest.TestCase):
    ...
    def test_empty_floor_breaks_the_freeze_and_exits(self):
        ...
        # the other occupant gets up; left now sees crosstalk. Keep left/right comparable
