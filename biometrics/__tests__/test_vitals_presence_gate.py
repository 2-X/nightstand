"""Tests for the vitals-insertion presence gate.
...
now. On a real overnight recording, LEFT kept inserting vitals for ~20
...
class TestVitalsPresenceGate(unittest.TestCase):
    ...
    def test_no_lag_gates_the_frame_presence_exits_on(self):
        """
        End-to-end version of the failure: establish real presence via
