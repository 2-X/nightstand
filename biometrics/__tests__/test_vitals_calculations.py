...
Run locally (needs numpy, scipy, pandas):
    python3 -m unittest biometrics.__tests__.test_vitals_calculations -v
...
class TestVitalsCalculations(unittest.TestCase):
    def test_calculate_kwargs_bind_to_vendored_process(self):
    ...
    def test_process_runs_with_calculate_kwargs(self):
        ...
        self.assertTrue(40 <= measurement['bpm'] <= 90)
