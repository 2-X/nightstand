...
discriminator (the `is_ambiguous_both` exit-freeze).
...
def ambiguous_should_advance(is_empty: bool,
    ...
    - Primary lever: advance whenever the floor looks empty.
    - Backstop: otherwise, once the ambiguous state has persisted past
