...
describe('buildCalibrationView', () => {
    ...
    it('distinguishes a carried-over profile from a genuinely poor one', () => {
        ...
        const imported = buildCalibrationView({ ...profile, quality: 0 }, { status: 'success', trigger: 'migration' });
        const poor = buildCalibrationView({ ...profile, quality: 0 }, { status: 'success', trigger: 'daily' });
