...
// keeps the guard.
const biometricsCalibrationLeft = () => executeCalibrateSensors('left', moment().subtract(2, 'hours').toISOString(), moment().add(1, 'hours').toISOString(), true);
const biometricsCalibrationRight = () => executeCalibrateSensors('right', moment().subtract(2, 'hours').toISOString(), moment().add(1, 'hours').toISOString(), true);
const JOB_MAP = {
    analyzeSleepLeft,
    analyzeSleepRight,
