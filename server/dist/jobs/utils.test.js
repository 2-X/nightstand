...
import { compareTimes, getDayIndexForTime, getDayOfWeekIndex, getPowerOffDayIndex, scheduleWrapsToNextDay, } from './utils.js';
const SUNDAY = 0;
const MONDAY = 1;
const TUESDAY = 2;
const SATURDAY = 6;
...
describe('getDayIndexForTime', () => {
    ...
    it('agrees with the power off day for the same schedule', () => {
        ...
        assert.equal(getDayIndexForTime('monday', power.off, power.on), getPowerOffDayIndex('monday', power));
    });
