...
describe('pod-installer.sh and serverInfo.json agree about the fork field', () => {
    ...
    it('has the fork field the installer reads out of a staged tree', () => {
        ...
        assert.ok(Object.hasOwn(serverInfo, 'fork'), 'pod-installer.sh reads serverInfo.json["fork"], so a tree without that field aborts every migration at the staged-tree check');
    });
