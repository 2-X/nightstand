...
let updateServices: typeof import('./services.js')['updateServices'];
let servicesDB: typeof import('./services.js')['default'];
let ServicesSchema: typeof import('./servicesSchema.js')['ServicesSchema'];
