...
/**
 * Reusable card layout shared by every metric chart on the Sleep page: a
 * row of "section label / big number" pairs along the top, then a chart
 * filling the rest of the card.
 *
 * Example usages:
